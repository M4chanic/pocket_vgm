...
package opl3_pkg;
    ...
    localparam CLK_DIV_COUNT = 256; // int'($ceil(CLK_FREQ/DESIRED_SAMPLE_FREQ)) — $ceil не синтезируется
    ...
    // m4pocket: 1 банк (OPL2-объём, 9 каналов) ради площади; ширина не 0
    localparam NUM_BANKS = 1;
    localparam NUM_OPERATORS_PER_BANK = 18;
    localparam NUM_CHANNELS_PER_BANK = 9;
    localparam BANK_NUM_WIDTH = NUM_BANKS > 1 ? $clog2(NUM_BANKS) : 1;
